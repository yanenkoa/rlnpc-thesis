...
def config_one():
    ...
    walls.extend([left_wall, top_wall, right_wall, bottom_wall])
    gold_chests = [
         GoldChest(85, Vector2(950, 50)),
         GoldChest(60, Vector2(50, 500)),
         GoldChest(75, Vector2(500, 950)),
         GoldChest(125, Vector2(50, 50)),
         GoldChest(75, Vector2(250, 50)),
         GoldChest(25, Vector2(750, 50)),
         GoldChest(12, Vector2(350, 450)),
...
def rl_config_alt_5() -> Tuple[LearningProcessConfig, NetworkConfig]:
    frames_in_second = 60
    n_skipped_frames = 10
    max_minutes = 10
    framerate = 1. / frames_in_second
...
def rl_config_alt_5_vc() -> Tuple[LearningProcessConfig, NetworkConfig]:
    frames_in_second = 60
    n_skipped_frames = 10
    max_minutes = 10
    framerate = 1. / frames_in_second
...
def rl_config_alt_5_vc_eps() -> Tuple[LearningProcessConfig, NetworkConfig]:
    frames_in_second = 60
    n_skipped_frames = 10
    max_minutes = 10
    framerate = 1. / frames_in_second
...
def rl_config_alt_5_vc_eps_less_anneal() -> Tuple[LearningProcessConfig, NetworkConfig]:
    frames_in_second = 60
    n_skipped_frames = 10
    max_minutes = 10
    framerate = 1. / frames_in_second
...
def main():
    config_funcs = [rl_config, rl_config_shallower, rl_config_two, rl_config_larger_lr_lower_clipnorm,
                    ...
                    rl_config_alt_5, rl_config_alt_5_vc, rl_config_alt_5_vc_eps, rl_config_alt_5_vc_eps_less_anneal]
